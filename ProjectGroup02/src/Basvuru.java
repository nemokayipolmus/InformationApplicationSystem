...
public class Basvuru {
	...
	public Basvuru(int kimlikNo, int basvuruNo, Date basvuruTarihi, int basvuruTipiNo, int basvuruDurumuNo,
	...
	public Basvuru(int kimlikNo, int basvuruTipiNo, int basvuruDurumuNo, int cevaplamaTipiNo, int cevapTurNo) {
		this.kimlikNo = kimlikNo;
		this.basvuruTipiNo = basvuruTipiNo;
		this.basvuruDurumuNo = basvuruDurumuNo;
		this.cevaplamaTipiNo = cevaplamaTipiNo;
	...
	public Object getByName(String attributeName) {
		...
		case "CevapAçýklama": return cevapAciklama;
		case "CevapTurNo": return cevapTurNo;
		default: return null;
		}
	}
	...
	public String toString() {
		return "Basvuru [kimlikNo=" + kimlikNo + ", basvuruNo=" + basvuruNo + ", basvuruTarihi=" + basvuruTarihi
